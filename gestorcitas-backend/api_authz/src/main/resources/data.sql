...
INSERT INTO authorities (name, endpoint) values ('Medico_Write', 'POST:/api/medico/');
INSERT INTO authorities (name, endpoint) values ('Medico_Read', 'GET:/api/medico/');
INSERT INTO authorities (name, endpoint) values ('MedicoById_Read', 'GET:/api/medico/{id}/');
INSERT INTO authorities (name, endpoint) values ('Medico_Delete', 'DELETE:/api/medico/{id}/');
INSERT INTO authorities (name, endpoint) values ('Medico_Update', 'PUT:/api/medico/{id}/');
INSERT INTO authorities (name, endpoint) values ('Medico_PartialUpdate', 'PATCH:/api/medico/{id}/');
